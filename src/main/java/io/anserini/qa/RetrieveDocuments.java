...
public class RetrieveDocuments {
    ...
    public RetrieveDocuments(RetrieveDocuments.Args args) throws Exception {
    ...
    public List<String> getRankedPassagesList(String query, String index, int hits, int k) throws Exception {
        ...
        for (Map.Entry<String, Float> doc : scoredDocs.entrySet()) {
            String rawDocument = util.getRawDocument(doc.getKey());
            sentencesMap.put(rawDocument, doc.getValue());
        }

        for(Map.Entry<String, Float> scoredDocsPair: sentencesMap.entrySet()) {
            topDocuments.add(scoredDocsPair.getKey() + "\t" + scoredDocsPair.getValue());
            System.out.println(scoredDocsPair.getKey() + " " + scoredDocsPair.getValue() + "\n\n\n");
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("Example: RetrieveDocuments" + parser.printExample(OptionHandlerFilter.REQUIRED));
            return;
        }
        ...
        RetrieveDocuments rs = new RetrieveDocuments(qaArgs);
        rs.retrieveDocuments(qaArgs.query, qaArgs.hits);
    }
}
